...
export type ContractContext = Web3ContractContext<
  RewardToken,
  RewardTokenMethodNames,
  RewardTokenEventsContext,
  RewardTokenEvents
>;
export type RewardTokenEvents =
  | 'Approval'
  | 'OwnershipTransferred'
  | 'Transfer';
export interface RewardTokenEventsContext {
  Approval(
    parameters: {
...
export type RewardTokenMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
