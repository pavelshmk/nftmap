...
class PlanetsToolbarComponent extends React.Component<IPlanetsToolbarProps, IPlanetsToolbarState> {
    ...
    render() {
        ...
        return (
            <div className="planets-toolbar switch-content-visibility">
                <div className="name">
                    ...
                    <div className="planet-number-block mobile-only">
                        <div className="row">
                            <div id="planetNumber" className="actual-planet-number"/>
                        ...
                        <div className="custom-input">
                            <div className="custom-search">
                                ...
                                <button type="submit" name="button"
                                        className="btn btn-box btn-chevron-right disabled"/>
                            </div>
                        </div>
                ...
                <div className={classNames('custom-switch', 'switch-icons', { show: activePlanet === PlanetsEnum.earth })} data-appear-onplanet='earth'>
                    <input type="checkbox" data-switch-content=".switch-content-visibility" name="custom-switch" />
